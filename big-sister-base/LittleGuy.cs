...
namespace big_sister_base
{
    public class LittleGuy
    {
        ...
        public EventHandler<EventProduct> AddedProduct;
        public delegate bool LittleGuyEventHandler(object source, EventArgs args);
        public event LittleGuyEventHandler CheckPay;
        ...
        protected void OnAddProduct(Product product)
        {
            ...
            {
                AddedProduct(this, new EventProduct() { Product = product });
            }
        }
        ...
        protected virtual bool OnCheckPay()
        {
            return CheckPay(this, EventArgs.Empty);
        }
